...
/**
 * PageKidsCornerMetaKeywordLink
 *
 * @ORM\Table(name="page_kids_corner_meta_keyword_link", uniqueConstraints={@ORM\UniqueConstraint(name="page_kids_corner_meta_keyword_link_reference_unique", columns={"reference"})})
 * @ORM\Entity
 */
class PageKidsCornerMetaKeywordLink
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="page_kids_corner_meta_keyword_link_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
     ...
     *
     * @return PageKidsCornerMetaKeywordLink
     */
