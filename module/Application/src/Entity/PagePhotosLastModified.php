...
/**
 * PagePhotosLastModified
 *
 * @ORM\Table(name="page_photos_last_modified")
 * @ORM\Entity
 */
class PagePhotosLastModified
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="page_photos_last_modified_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
