...
/**
 * PageRssMetaDescription
 *
 * @ORM\Table(name="page_rss_meta_description", uniqueConstraints={@ORM\UniqueConstraint(name="page_rss_meta_description_reference_unique", columns={"reference"})})
 * @ORM\Entity
 */
class PageRssMetaDescription
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="page_rss_meta_description_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
