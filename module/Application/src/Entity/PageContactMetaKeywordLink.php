...
/**
 * PageContactMetaKeywordLink
 *
 * @ORM\Table(name="page_contact_meta_keyword_link", uniqueConstraints={@ORM\UniqueConstraint(name="page_contact_meta_keyword_link_reference_unique", columns={"reference"})})
 * @ORM\Entity
 */
class PageContactMetaKeywordLink
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="page_contact_meta_keyword_link_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
     ...
     *
     * @return PageContactMetaKeywordLink
     */
