 ...
 * PagePricing
 *
 * @ORM\Table(name="page_pricing", uniqueConstraints={@ORM\UniqueConstraint(name="page_pricing_reference_unique", columns={"reference"})})
 * @ORM\Entity
 */
class PagePricing
{
     ...
     * @ORM\SequenceGenerator(sequenceName="page_pricing_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
