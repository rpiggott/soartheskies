 ...
 * PageContact
 *
 * @ORM\Table(name="page_contact", uniqueConstraints={@ORM\UniqueConstraint(name="page_contact_reference_unique", columns={"reference"})})
 * @ORM\Entity
 */
class PageContact
{
     ...
     * @ORM\SequenceGenerator(sequenceName="page_contact_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
