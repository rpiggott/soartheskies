...
/**
 * PageStoreLastModified
 *
 * @ORM\Table(name="page_store_last_modified")
 * @ORM\Entity
 */
class PageStoreLastModified
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="page_store_last_modified_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
