...
/**
 * PageSearchLastModified
 *
 * @ORM\Table(name="page_search_last_modified")
 * @ORM\Entity
 */
class PageSearchLastModified
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="page_search_last_modified_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
