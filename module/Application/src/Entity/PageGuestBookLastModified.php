...
/**
 * PageGuestBookLastModified
 *
 * @ORM\Table(name="page_guest_book_last_modified")
 * @ORM\Entity
 */
class PageGuestBookLastModified
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="page_guest_book_last_modified_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
     ...
     *
     * @return PageGuestBookLastModified
     */
