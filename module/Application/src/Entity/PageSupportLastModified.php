...
/**
 * PageSupportLastModified
 *
 * @ORM\Table(name="page_support_last_modified")
 * @ORM\Entity
 */
class PageSupportLastModified
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="page_support_last_modified_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
     ...
     *
     * @return PageSupportLastModified
     */
