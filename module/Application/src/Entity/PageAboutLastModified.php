...
/**
 * PageAboutLastModified
 *
 * @ORM\Table(name="page_about_last_modified")
 * @ORM\Entity
 */
class PageAboutLastModified
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="page_about_last_modified_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
