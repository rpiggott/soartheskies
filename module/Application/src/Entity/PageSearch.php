 ...
 * PageSearch
 *
 * @ORM\Table(name="page_search", uniqueConstraints={@ORM\UniqueConstraint(name="page_search_reference_unique", columns={"reference"})})
 * @ORM\Entity
 */
class PageSearch
{
     ...
     * @ORM\SequenceGenerator(sequenceName="page_search_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
