 ...
 * PageSupport
 *
 * @ORM\Table(name="page_support", uniqueConstraints={@ORM\UniqueConstraint(name="page_support_reference_unique", columns={"reference"})})
 * @ORM\Entity
 */
class PageSupport
{
     ...
     * @ORM\SequenceGenerator(sequenceName="page_support_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
