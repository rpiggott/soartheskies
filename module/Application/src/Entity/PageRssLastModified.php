 ...
 * PageRssLastModified
 *
 * @ORM\Table(name="page_rss_last_modified")
 * @ORM\Entity
 */
class PageRssLastModified
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="page_rss_last_modified_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
