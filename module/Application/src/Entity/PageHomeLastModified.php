...
/**
 * PageHomeLastModified
 *
 * @ORM\Table(name="page_home_last_modified")
 * @ORM\Entity
 */
class PageHomeLastModified
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="page_home_last_modified_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
