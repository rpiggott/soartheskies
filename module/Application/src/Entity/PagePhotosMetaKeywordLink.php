...
/**
 * PagePhotosMetaKeywordLink
 *
 * @ORM\Table(name="page_photos_meta_keyword_link", uniqueConstraints={@ORM\UniqueConstraint(name="page_photos_meta_keyword_link_reference_unique", columns={"reference"})})
 * @ORM\Entity
 */
class PagePhotosMetaKeywordLink
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="page_photos_meta_keyword_link_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
     ...
     *
     * @return PagePhotosMetaKeywordLink
     */
