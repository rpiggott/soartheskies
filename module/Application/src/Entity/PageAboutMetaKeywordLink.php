...
/**
 * PageAboutMetaKeywordLink
 *
 * @ORM\Table(name="page_about_meta_keyword_link", uniqueConstraints={@ORM\UniqueConstraint(name="page_about_meta_keyword_link_reference_unique", columns={"reference"})})
 * @ORM\Entity
 */
class PageAboutMetaKeywordLink
{
     ...
     * @ORM\SequenceGenerator(sequenceName="page_about_meta_keyword_link_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
     ...
     *
     * @return PageAboutMetaKeywordLink
     */
