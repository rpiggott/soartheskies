...
/**
 * PageSearchMetaKeywordLink
 *
 * @ORM\Table(name="page_search_meta_keyword_link", uniqueConstraints={@ORM\UniqueConstraint(name="page_search_meta_keyword_link_reference_unique", columns={"reference"})})
 * @ORM\Entity
 */
class PageSearchMetaKeywordLink
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="page_search_meta_keyword_link_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
     ...
     *
     * @return PageSearchMetaKeywordLink
     */
