...
/**
 * PageStoreMetaDescription
 *
 * @ORM\Table(name="page_store_meta_description", uniqueConstraints={@ORM\UniqueConstraint(name="page_store_meta_description_reference_unique", columns={"reference"})})
 * @ORM\Entity
 */
class PageStoreMetaDescription
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="page_store_meta_description_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
     ...
     *
     * @return PageStoreMetaDescription
     */
