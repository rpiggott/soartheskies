 ...
 * PageGuestBook
 *
 * @ORM\Table(name="page_guest_book", uniqueConstraints={@ORM\UniqueConstraint(name="page_guest_book_reference_unique", columns={"reference"})})
 * @ORM\Entity
 */
class PageGuestBook
{
     ...
     * @ORM\SequenceGenerator(sequenceName="page_guest_book_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
