...
/**
 * PageKidsCornerLastModified
 *
 * @ORM\Table(name="page_kids_corner_last_modified")
 * @ORM\Entity
 */
class PageKidsCornerLastModified
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="page_kids_corner_last_modified_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
     ...
     *
     * @return PageKidsCornerLastModified
     */
