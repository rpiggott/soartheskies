...
/**
 * PageSupportMetaKeywordLink
 *
 * @ORM\Table(name="page_support_meta_keyword_link", uniqueConstraints={@ORM\UniqueConstraint(name="page_support_meta_keyword_link_reference_unique", columns={"reference"})})
 * @ORM\Entity
 */
class PageSupportMetaKeywordLink
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="page_support_meta_keyword_link_reference_seq", allocationSize=1, initialValue=1)
     */
    private $reference;
     ...
     *
     * @return PageSupportMetaKeywordLink
     */
